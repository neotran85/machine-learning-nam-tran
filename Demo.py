...
if uploaded_image:
    if st.button("Hãy mô tả hình ảnh vừa upload"):
        ...
        with st.spinner('Đang phân tích...'):
            ...
            asticaAPI_gpt_prompt = 'In Vietnamese, describe the image about its meaning, messages, layout, positions, colors, as a pro designer. Finally show how to improve it.'
